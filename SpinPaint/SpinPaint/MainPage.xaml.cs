...
namespace SpinPaint
{
    public partial class MainPage : ContentPage
    {
        ...
        void OnIncreaseSizeButtonClicked(object sender, EventArgs args)
        {
            fingerPaint.StrokeWidth += 2; // Aumentar el tamaño del puntero
        }

        void OnDecreaseSizeButtonClicked(object sender, EventArgs args)
        {
            if (fingerPaint.StrokeWidth > 2)
            {
                fingerPaint.StrokeWidth -= 2; // Disminuir el tamaño del puntero, asegurándote de que no sea menor que 2
            }
        }
